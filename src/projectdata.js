...
export const projectdata = [
    ...
    },
    {
      ...
      description:
        "An android application that allows a user to create notes. Includes features such as filtering notes by importance and by a search text, deleting notes, randomly creating notes, and clearing notes.",
    ...
    },
    {
      ...
      tools: "JavaFX, Kotlin",
      description:
      "A JavaFX application that allows a user to create notes. Includes features such as filtering notes by importance and by a search text, deleting notes, randomly creating notes, and clearing notes. Dragging a .txt file onto the application creates a note with its contents.",
